...
const quizData = [
    {
        ...
        options: ["Monaco", "Maldives", "Vatican City", "Malta"],
        answer: "Vatican City"
        },
        {
        question: "What is the fullform of 'NASA'?",
        options: ["National Aeronautics and Space Administration", "National Administration of Space and Aeronautics", "National Aeronautics and Space Authority", "National Administration of Space and Aeronautics"],
